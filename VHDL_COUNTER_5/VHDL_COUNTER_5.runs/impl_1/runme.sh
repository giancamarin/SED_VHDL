...
HD_PWD='C:/Users/gmari/Documents/Mis_documentos/Universidad/UPM/565000172/Proyectos/SED_VHDL/VHDL_COUNTER_5/VHDL_COUNTER_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log maquina_contador.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source maquina_contador.tcl -notrace
