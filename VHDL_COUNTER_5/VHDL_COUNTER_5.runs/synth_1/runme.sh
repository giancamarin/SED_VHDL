...
HD_PWD='C:/Users/gmari/Documents/Mis_documentos/Universidad/UPM/565000172/Proyectos/SED_VHDL/VHDL_COUNTER_5/VHDL_COUNTER_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log maquina_contador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source maquina_contador.tcl
